...
DocumentReference? get currentUserReference =>
    loggedIn ? UserPaskasRecord.collection.doc(currentUser!.uid) : null;

UserPaskasRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserPaskasRecord.getDocument(UserPaskasRecord.collection.doc(uid))
              .handleError((_) {}),
    )
